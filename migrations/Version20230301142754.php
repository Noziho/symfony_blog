 ...
 */
final class Version20230301142754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentary ADD user_id INT DEFAULT NULL, ADD message VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentary DROP user_id, DROP message');
    }
}
